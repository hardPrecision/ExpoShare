(function () {
    ...
    toolbar.addEventListener('click', e => {
        if (e.target.dataset.action) {
            ...
            if (act === 'align-left') {
                insertAround('<div style="text-align:left;">', '</div>');
                return;
            }
            if (act === 'align-center') {
                insertAround('<div style="text-align:center;">', '</div>');
                return;
            }
            if (act === 'align-right') {
                insertAround('<div style="text-align:right;">', '</div>');
                return;
            }
